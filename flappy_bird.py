...
class Bird():
    ...
    def move(self):
        ...
        d = self.vel*self.tick__count + 1.5*self.tick__count**2
...
# todo: Saving the AI
# use pickel module to save the best Neural .. 
# save winner object - best genome after some threshold... pickel that save in a file ... then load that file and use that neural network to play the game/jump bird
# note : make a seperate function for that only run one best bird